...
--scenario_name "simple_encirclement_4agt" \
--max_edge_dist 2.0 \
--safety_bound 1.0 \
--clip_param 0.15 --gamma 0.99 \
--hidden_size 64 \
--num_targets 1 --num_agents 4 --num_obstacles 5 --num_landmarks 0 \
--save_data "True" \
--reward_file_name "rew_enc_4agt_PS" \
--cost_file_name "cost_enc_4agt_PS" \
