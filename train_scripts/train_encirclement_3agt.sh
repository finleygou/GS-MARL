...
--save_data "True" \
--reward_file_name "rew_enc_3agt_PS-v20" \
--cost_file_name "cost_enc_3agt_PS-v20" \
--kl_threshold 0.05 \
--parameter_share "True" \
--use_curriculum "False" --cp 0.6 \
--use_wandb "True" \
--n_training_threads 128 --n_rollout_threads 32 \
--episode_length ${ep_lens} \
--num_env_steps 10000000 \
--data_chunk_length 20 \
--fraction_coef 0.1 --line_search_fraction 0.6 \
--gain 0.01 --lr 2e-3 --critic_lr 2e-3 \
--user_name "finleygou"
done