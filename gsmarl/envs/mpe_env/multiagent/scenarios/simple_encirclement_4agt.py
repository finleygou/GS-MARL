...
class Scenario(BaseScenario):
    ...
    def reset_world(self, world):
        ...
        init_pos_agent = np.array([[-1.2, 0.], [-0.4, 0.0], [0.4, 0.0], [1.2, 0.0]])
        ...
        init_pos_obstacle = np.array([[-1.31, 2.25], [-0.44, 1.06], [0.32, 2.10], [0.94, 0.88], [1.44, 2.75]])
        for i, obstacle in enumerate(world.obstacles):
