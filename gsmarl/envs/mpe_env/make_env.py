...
def make_env(args, benchmark=False):
    ...
    '''
    from gsmarl.envs.mpe_env.multiagent.environment import MultiAgentEnv, MultiAgentConstrainEnv, MultiAgentGraphConstrainEnv
    import gsmarl.envs.mpe_env.multiagent.scenarios as scenarios
